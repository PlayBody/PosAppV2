...
class AdminMesseageList extends StatefulWidget {
  const AdminMesseageList({super.key});

  @override
  State<AdminMesseageList> createState() => _AdminMesseageList();
}
...
class _AdminMesseageList extends State<AdminMesseageList> {
  ...
  Future<List> loadMessageUserList() async {
    ...
    await Webservice()
        .loadHttp(context, apiLoadMessageUserListUrl, {
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            return Container(
              ...
              child: Column(
                children: [_getSearchContent(), _getUserListContent()],
              ),
            );
