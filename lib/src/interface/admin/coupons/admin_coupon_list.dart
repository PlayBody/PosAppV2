          ...
          Row(
            children: [
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                        image: e.iconUrl == null
                            ? NetworkImage(apiBase + "/assets/images/coupons/noimages.jpg")
                            : NetworkImage(apiBase + "/assets/images/coupons/" + e.iconUrl!),
                        fit: BoxFit.cover,
                      ),
            ...
            SizedBox(width: 8),
              Container(
                  ...
                  child: Text(e.couponName, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14))),
