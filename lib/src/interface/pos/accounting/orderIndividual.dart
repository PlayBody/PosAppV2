  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        if (num == 'C') {
          ...
          if (num == '+/-') {
            ...
            if (isMinus) {
              ...
              orderIndividualAmount = orderIndividualAmount!.replaceAll(
                "-",
                '',
              );
            }
        ...
        txtIndividualAmountController.text =
            isMinus
                ? '-${Funcs().currencyFormat(orderIndividualAmount!.replaceAll('-', ''))}'
